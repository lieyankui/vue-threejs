...
export default {
  ...
  methods: {
    ...
    render() {
      ...
      matrix = m3.rotate(matrix,m3.degToRad(this.rotateAngle));
      matrix = m3.scale(matrix,this.scaleX, this.scaleY);
      matrix = m3.translate(matrix,-this.width / 2, -this.height /2);
      // 设置颜色
      gl.uniform4f(
        this.colorUniformLocation,
